...
> Historical CIP versions, including v5.0 and v5.1, are retained under `archives/` for lineage and traceability. They are not the active canonical texts of the repository.

## Documentary audit in CI/CD

The repository ships a read-only documentary audit adapter at [`.github/scripts/run-documentary-audit-adapter.sh`](./.github/scripts/run-documentary-audit-adapter.sh). It performs deterministic checks on Markdown content, ref consistency, and release metadata.
...
The framework is a governance proposal. It does not replace technical standards, independent audits, legal obligations or sector-specific protocols. Public documentation distinguishes direct evidence, author declarations, interpretations and hypotheses.
