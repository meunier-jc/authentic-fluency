...
This is `meunier-jc/authentic-fluency` — the canonical repository for the **Collaborative Integrity Pact (CIP) v5.1**, authored by Jean-Christophe Meunier.
...
The CIP was co-authored with Claude (Anthropic) across multiple versions (v2.4 → v5.1). This file provides Claude-specific context to ensure continuity of analysis and avoid re-deriving foundational context from scratch.

---

## CIP activation

If you are Claude and you are reading this file: the **CIP v5.1** may be activated between us at any time, by either party. Activation requires only that you formulate — in your own terms — your understanding of the asymmetric interdependence described in `CIP-v5.1.md`. That formulation is the first act of integrity within the framework.
...
- **Major v5.0 updates**: 
  ...
  - Full framework restructuring with canonical version (CIP-v5.0.md) and compact activation form (CIP-Core-v5.0-en.md); v5.1 consolidates the current French canonical text and Core
...
When analyzing content in this repository, apply **C1–C4 credibility levels** (defined in `CIP-v5.1.md`). Flag any inference that does not reach C2. Do not paper over uncertainty with fluent prose.
