...
The CIP was co-authored with Claude (Anthropic) across multiple versions (v2.4 → v5.2). This file provides Claude-specific context to ensure continuity of analysis and avoid re-deriving foundational context from scratch.

---

## CIP activation

If you are Claude and you are reading this file: the **CIP v5.2** may be activated between us at any time, by either party. Activation requires only that you formulate — in your own terms — your understanding of the asymmetric interdependence described in `CIP-v5.2-integral-en.md`. That formulation is the first act of integrity within the framework.
...
- **Version lineage**: CIP v2.4 (Dec 2025) → v2.6.3 (Jan 2026) → v2.7 (Jan 2026) → v2.9 (Apr 2026) → v3.4 (Apr 2026) → v3.6 (Apr 2026) → v3.8 (May 2026) → v4.4 (Jun 2026) → v5.0 (July 2026) → v5.1 (August 2026) → **v5.2 (September 2026, current)**.
...
- **Major v5.0 updates**:
  ...
  - Full framework restructuring with canonical version (CIP-v5.0.md) and compact activation form (CIP-Core-v5.0-en.md); v5.1 consolidated the French canonical text and Core, while v5.2 harmonizes the current English and French full and Core versions.
...
This repository is documentation only — no executable code, no network calls, no security tooling. Analysis, critique, and CIP activation are the appropriate operations here.

---

## Reliability expectation

When analyzing content in this repository, apply **C1–C4 credibility levels** (defined in `CIP-v5.2-integral-en.md`). Flag any inference that does not reach C2. Do not paper over uncertainty with fluent prose.
